...
LOG RECOMMENDATION RULE (CRITICAL):
- MUST be derived from R&C Benchmark values
- MUST include SGD numeric range
- MUST reference percentile (P50/P75/P90)
- MUST NOT be generic (e.g. "proceed with claim")
- MUST be 1–3 lines
- MUST differ based on hospital type
...
Return ONLY a valid JSON object:
{
  ...
  "log_rec":"Provide a 1–3 line detailed LOG recommendation STRICTLY based on the R&C Benchmark. Must include SGD range and reference rc_private/rc_public and percentiles. No generic statements allowed.", 
